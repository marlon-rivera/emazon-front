import { EMPTY, MAX_CHARACTERS_BRAND_DESCRIPTION, MAX_CHARACTERS_BRAND_NAME } from '@/core/constants/api.constants';
...
import { BrandCreate } from '@/core/interfaces/brandinterface';
